...
export default function CharMultiEnd() {
  const board = useCharNetStore((s) => s.endLeaderboard);
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10 text-center">
      ...
      {!isHost && (
        <p className="mt-3 text-xs text-white/40">Thanks for playing! The host can start a new game.</p>
      )}
    </div>
  );
}
